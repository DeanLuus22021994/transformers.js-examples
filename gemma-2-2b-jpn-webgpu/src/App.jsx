        ...
        <div className="h-full overflow-auto scrollbar-thin flex justify-center items-center flex-col relative">
          <div className="flex flex-col items-center mb-1 max-w-[340px] text-center">
            <img
              ...
              className="block"
            ></img>
            <h1 className="text-4xl font-bold mb-1">Gemma 2 JPN WebGPU</h1>
            <h2 className="font-semibold">
              Gemma-2-JPN running locally <br />
          ...
          <div className="flex flex-col items-center px-4">
            <p className="max-w-[514px] mb-4">
              ...
              , a 2.61 billion parameter LLM that is optimized for inference on
              the web. Once downloaded, the model (2.5&nbsp;GB) will be cached
              ...
              <a
                href="https://github.com/huggingface/transformers.js-examples/tree/main/gemma-2-2b-jpn-webgpu"
                target="_blank"
                rel="noreferrer"
                className="underline"
              >
