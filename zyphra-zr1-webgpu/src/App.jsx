      ...
      {status === null && messages.length === 0 && (
        <div className="h-full overflow-auto scrollbar-thin flex justify-center items-center flex-col relative">
          <div className="flex flex-col items-center mb-1 max-w-[360px] text-center">
            ...
            ></img>
            <h1 className="text-4xl font-bold my-1">Zyphra-ZR1 WebGPU</h1>
            <h2 className="font-semibold">
              A small reasoning model that runs locally in your browser with
              WebGPU acceleration.
            </h2>
          </div>
          ...
          <div className="flex flex-col items-center px-4">
            <p className="max-w-[480px] mb-4">
              ...
              <a
                href="https://huggingface.co/onnx-community/ZR1-1.5B-ONNX"
                target="_blank"
                rel="noreferrer"
              ...
              is available on{" "}
              <a
                href="https://github.com/huggingface/transformers.js-examples/tree/main/zyphra-zr1-webgpu"
                target="_blank"
                rel="noreferrer"
                className="font-medium underline"
              >
