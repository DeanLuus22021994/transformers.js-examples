...
async function activate(context) {
    ...
    logger.info('Debt Engine has been activated');
    ...
    setTimeout(async () => {
        ...
        const vsCodeEnabled = vscode.workspace.getConfiguration('debtEngine').get('enabled', true);
